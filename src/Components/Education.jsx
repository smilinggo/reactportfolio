export default function Education() {
    return (
        <div>
        <section className="h-full flex ml-6 py-px max-w-6xl w-3/4 font-primary-text leading-relaxed mb-12" id="Education">
            <div className="h-1/2 self-center">
                    <h2 className="mt-6 mb-8 text-6xl font-semibold">Education</h2>
                    <div class=" mb-5">
